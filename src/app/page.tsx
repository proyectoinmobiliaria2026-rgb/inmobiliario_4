...
const SHORTCUTS = [
  ...
  },
  {
    ...
    accent: "from-indigo-500 to-red-600"
  },
  {
    href: "/dashboard",
    title: "Dashboard",
    ...
    accent: "from-red-500 to-indigo-700"
  }
];
  ...
  return (
    <div className="relative">
      <div aria-hidden className="fixed inset-0 -z-10 overflow-hidden bg-gradient-to-b from-white via-indigo-50/70 to-slate-200">
        ...
        <div className="absolute -top-40 left-1/2 h-96 w-[70rem] -translate-x-1/2 rounded-full bg-gradient-to-r from-indigo-300/50 via-red-300/40 to-indigo-300/50 blur-3xl" />
        <div className="absolute top-1/2 -left-48 h-96 w-96 rounded-full bg-red-200/50 blur-3xl" />
        <div className="absolute -right-48 bottom-0 h-96 w-96 rounded-full bg-indigo-200/50 blur-3xl" />
      </div>

      <div className="grid gap-8">
        <section className="relative overflow-hidden rounded-3xl border border-white/20 bg-gradient-to-br from-indigo-950 via-indigo-900 to-red-950 px-6 py-10 shadow-xl sm:px-10">
          <div
            aria-hidden
          ...
          <div
            aria-hidden
            className="absolute inset-0 -z-10 bg-gradient-to-r from-indigo-950/70 via-indigo-950/45 to-red-950/20"
          />
