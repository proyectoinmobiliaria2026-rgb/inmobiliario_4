...
import { publishPublicationNow } from "@/lib/services/publication-service";
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    return NextResponse.json({ ok: true, data: await publishPublicationNow(supabase, (await context.params).id) });
