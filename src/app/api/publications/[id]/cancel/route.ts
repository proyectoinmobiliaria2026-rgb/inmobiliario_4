...
import { cancelPublication } from "@/lib/services/publication-service";
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    return NextResponse.json({ ok: true, data: await cancelPublication(supabase, (await context.params).id) });
