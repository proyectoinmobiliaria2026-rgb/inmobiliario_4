...
export function DashboardSummaryView() {
  ...
  const stats = [
    ...
    { testId: "stat-properties-active", label: "En comercialización", value: summary.propertiesActive, icon: "M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" },
    ...
    { testId: "stat-pending-photos", label: "Pendientes de fotos", value: summary.pendingPhotos, icon: "M2.25 15.75l5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" },
    { testId: "stat-pending-staging", label: summary.stagingIntegrated ? "Pendientes de staging" : "Pendientes de staging (integración pendiente)", value: summary.pendingStaging, icon: "M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z" },
    { testId: "stat-printable-available", label: "Vista imprimible disponible", value: summary.printableAvailable, icon: "M6.72 8.25h10.56v9.75H6.72V8.25ZM3.75 6.75h16.5M5.25 3.75h13.5v2.25H5.25V3.75Zm0 16.5h13.5v2.25H5.25v-2.25Z" },
    { testId: "stat-copies-pending", label: "Copies pendientes (FB/IG/TK)", value: summary.copiesPending, icon: "M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" },
    { testId: "stat-publications-scheduled", label: "Publicaciones programadas", value: summary.publicationsScheduled, icon: "M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0V11.25c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v7.5m-18 0h18" },
    { testId: "stat-publications-published", label: summary.socialIntegrated ? "Publicaciones realizadas" : "Publicaciones internas (sin confirmar red social)", value: summary.publicationsPublishedInternal, icon: "M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" },
    { testId: "stat-reel-pending", label: summary.reelIntegrated ? "Reels generados" : "Reel (integración pendiente)", value: 0, icon: "m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 2.25 7.5v9a2.25 2.25 0 0 0 2.25 2.25Z" },
    { testId: "stat-social-confirmed", label: summary.socialIntegrated ? "Confirmadas en red social" : "Confirmadas en red social (integración pendiente)", value: 0, icon: "M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Z" }
  ];
    ...
    <section className="workbench" data-testid="dashboard-summary">
      ...
      <div className="card" data-testid="recent-published">
        <div className="border-b border-slate-100 px-5 py-4">
          <h2 className="panel-title">En comercialización recientemente</h2>
        </div>
        <div className="p-5">
          <div className="list">
            {summary.recentPublished.map((item) => (
              <div key={item.id} className="property-row">
                ...
                <span className="muted">{item.folio ?? "—"}</span>
                <span className="muted">{item.city ?? "—"}</span>
              </div>
            ))}
            {summary.recentPublished.length === 0 && (
              <p className="muted">Sin propiedades en comercialización todavía.</p>
            )}
          </div>
        </div>
      </div>
