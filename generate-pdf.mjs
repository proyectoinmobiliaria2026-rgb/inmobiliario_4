...
const md = readFileSync('diagnostico-cfdigital-actual.md', 'utf8');
...
<head>
  <meta charset="UTF-8">
  <title>Diagnóstico CFDIGITAL</title>
  <style>
    @page {
      size: A4;
      margin: 20mm;
...
<body>
  <div class="header-info">
    <p style="margin: 0;"><strong>Fecha:</strong> 28 de agosto de 2026</p>
  ...
  <p style="margin-top: 40px; font-size: 9pt; color: #666; text-align: center;">
    Generado por Claude Code | 28/08/2026 18:33 UTC
  </p>
</body>
</html>`;

writeFileSync('diagnostico-cfdigital-actual.html', fullHtml);
console.log('HTML generado: diagnostico-cfdigital-actual.html');
console.log('\nPara convertir a PDF, puedes:');
console.log('1. Abrir el HTML en Chrome y usar Ctrl+P -> Guardar como PDF');
console.log('2. Usar una herramienta como wkhtmltopdf');
